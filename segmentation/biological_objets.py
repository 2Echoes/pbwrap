...
from ..utils import compute_anisotropy_coef, compute_voxel_volume, gaussian_kernel_size
...
def centrosome_segmentation_candidate_regions(image, centrosome_size, voxel_size, gaussian_fit = 'FWTM', threshold_penalty = 1) :
    """
